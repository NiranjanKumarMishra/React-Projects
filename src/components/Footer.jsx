...
const Footer = ({ theme }) => {
  return (
    ...
    >
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        ...
        >
          ...
          <div className='flex gap-2 text-sm'>
            ...
            />
            <button className='bg-primary text-white rounded px-6 hover:bg-primary/90 transition-all'>
              Subscribe
            </button>
          </div>
        </motion.div>
      ...
      {/* Bottom Section */}
      <motion.div
        initial={{ opacity: 0 }}   // ✅ fixed
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.4 }}
        viewport={{ once: true }}
        className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'
      >
        <p>© 2025 agency.io - Greatstack - All Rights Reserved</p>
